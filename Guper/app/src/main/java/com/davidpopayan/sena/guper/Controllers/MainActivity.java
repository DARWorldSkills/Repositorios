...
public class MainActivity extends AppCompatActivity
    ...
    TextView txtNombreMenu, txtcargo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Login.iniciarSesion == 1){
            ...
            txtcargo = view1.findViewById(R.id.cargo);
            txtcargo.setText("Aprendiz");
        ...
        if (Login.iniciarSesion == 2){
            ...
            txtcargo = view2.findViewById(R.id.cargo);
            txtcargo.setText("Instructor");
        }
        listarInstructor();
    ...
    public void onBackPressed() {
        ...
        if (drawer.isDrawerOpen(GravityCompat.START)) {
            ...
            alertDialog.setMessage("Estás seguro que quieres salir de la aplicación?");
